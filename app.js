...
function renderAjustes() {
  ...
  return `
    ...
    <p style="font-size:11.5px; color:var(--text-faint); margin:-4px 0 10px; line-height:1.5;">
      O número de patrimônio é registrado dentro de cada armário, mas não aparece na grade — é só para consulta interna.
    </p>
...
function openArmarioSheet(armarioId) {
  ...
  openSheet({
    ...
    bodyHtml: `
      ...
      <details class="patrimonio-details" ${arm.patrimonio ? 'open' : ''}>
        <summary>Nº de patrimônio (controle interno)</summary>
